...
❗️ Replace `itNepes` with your Github username and copy the links to `Pull Request` description:

- [DEMO LINK](https://itNepes.github.io/layout_stars/)
- [TEST REPORT LINK](https://itNepes.github.io/layout_stars/report/html_report/)
